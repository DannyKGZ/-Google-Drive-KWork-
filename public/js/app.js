        ...
        worksGrid.innerHTML = `
          <div class="works-empty">
            ...
            <ol style="text-align:left; max-width:520px; margin:1rem auto; color:var(--text-muted);">
              <li><strong>Способ 1 (проще):</strong> разверните скрипт из <code>apps-script/Code.gs</code> на <a href="https://script.google.com" target="_blank" rel="noopener">script.google.com</a></li>
              <li>Deploy → Web app → доступ «Anyone» → скопируйте URL</li>
              <li>В <code>.env</code> добавьте: <code>GOOGLE_APPS_SCRIPT_URL=ваш_url</code></li>
              <li><strong>Способ 2:</strong> <a href="https://console.cloud.google.com/" target="_blank" rel="noopener">Google Cloud Console</a> → Drive API → API Key → <code>GOOGLE_API_KEY=AIza...</code></li>
              <li>Перезапустите сервер: <code>npm start</code></li>
            </ol>
          </div>
        `;
      }
